/*
 * @(#)CardNewUserRequest.java $version 2013-5-16
 *
...
/**
 * nhn ufnet-ws
 * com.ufnet.ws.server.model.CardNewUserRequest.java
 * @author st13902
 * @date 2013-5-16
 */
@XmlRootElement(name = "CardNewUser", namespace = SimpleConstants.NAMESPACE)
public class CardNewUserRequest {
